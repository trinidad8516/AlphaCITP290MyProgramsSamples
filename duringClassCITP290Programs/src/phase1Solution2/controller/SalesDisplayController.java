package phase1Solution2.controller;

import java.math.BigDecimal;
import java.util.Arrays;
import java.util.Scanner;

import phase1SolutionWithFile.data.CashPayment;
import phase1SolutionWithFile.data.CheckPayment;
import phase1SolutionWithFile.data.CreditPayment;
import phase1SolutionWithFile.data.Employee;
import phase1SolutionWithFile.data.Payment;
import phase1SolutionWithFile.data.Product;
import phase1SolutionWithFile.model.SalesDisplayModel;
import phase1SolutionWithFile.view.SalesDisplayView;
 ...
 * sales until the employee chooses to log out.
 * 
 * @author hoffmanz
 * 
 */
